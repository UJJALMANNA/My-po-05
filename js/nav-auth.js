...
(async function updateNavAuthState() {
  ...
  const mobileLoginLinks = document.getElementById("mobileLoginLinks"); // ← ADDED
  ...
  if (session) {
    ...
    // 2. Hide mobile login links  ← ADDED
    if (mobileLoginLinks) mobileLoginLinks.style.display = "none";

    // 3. Show user profile pill with name
    ...
    // 4. Wire up dropdown toggle click
    ...
    if (mobileLoginLinks) mobileLoginLinks.style.display = ""; // ← ADDED
  }
})();
